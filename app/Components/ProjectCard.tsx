...
const ProjectCard = ({ project }: ProjectCardProps) => {
  ...
  return (
    <div
      className={`rounded-3xl overflow-hidden p-6 flex flex-col justify-between transition-all duration-300 border group ${
        isDark
      ...
      <div className="flex flex-col sm:flex-row gap-3 mt-4">
        {project.liveUrl && (
          <a
            ...
            className={`px-6 py-3 rounded-xl font-bold text-lg flex-1 text-center flex items-center justify-center gap-2 transition-all ${
              isDark
        ...
        {project.githubUrl && (
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className={`px-6 py-3 rounded-xl font-bold text-lg border-2 flex-1 text-center flex items-center justify-center gap-2 transition-all ${
              isDark
